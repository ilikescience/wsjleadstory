        ...
        json.forEach( (item) => {
            if (item.articles.length > 0) {
                item.articles.forEach((article) => {
                    ...
                    if (article.hasOwnProperty('image') && article.image && article.image.widths['620']) {
                        console.log(article.image.widths['620']);
